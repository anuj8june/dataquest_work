...
array = ['FILM', 'RT_user_norm', 'Metacritic_user_nom', 'IMDB_norm', 'Fandango_Ratingvalue', 'Fandango_Stars']
norm_reviews = reviews[array]
...
ax2.scatter(reviews["RT_user_norm"],reviews["Metacritic_user_nom"])
ax2.set_ylabel("Fandango")
