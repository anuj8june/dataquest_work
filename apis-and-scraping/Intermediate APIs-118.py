...
respon = requests.get("https://api.github.com/users/VikParuchuri/orgs", headers=headers)
orgs = respon.json()
...
pay_load = {"name": "learning-about-apis"}
posted = requests.post("https://api.github.com/user/repos", json=pay_load, headers=headers)
...
pay_load = {"description": "Learning about requests!", "name": "learning-about-apis"}
respons = requests.patch("https://api.github.com/repos/VikParuchuri/learning-about-apis", json=pay_load, headers=headers)
...
respons = requests.delete("https://api.github.com/repos/VikParuchuri/learning-about-apis", headers=headers)
status = respons.status_code